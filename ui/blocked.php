...
//         // Lấy đối tượng Contact từ CSDL hoặc bất cứ nguồn dữ liệu nào
//         $contact = new Contact(); // Thay bằng cách lấy từ CSDL
//         $_SESSION['selected_contact'] = $contact;
//         // Chuyển hướng đến trang khác nếu cần thiết
//     }
// }
?>
...
<body>
    ...
    <div class="container" style="margin-top: 70px;">
        ...
        if (isset($_POST["find"])) {
            ...
            include_once "../bl/find_blocked.php";
        } else {
            // Hiển thị danh sách liên hệ mặc định
            include_once "../bl/view_blocked.php";
        }
        ?>
    </div>
    <script>
